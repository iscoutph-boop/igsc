...
if (json.version !== '6.2-staging-self-service') throw new Error(`Expected 6.2-staging-self-service, received ${json.version || 'no version'}.`);
console.log(`V6.2 health PASS: ${json.version}`);
