    ...
    <footer className="border-t border-border bg-surface/60 mt-16">
      <div className="max-w-[1500px] mx-auto px-6 md:px-10 py-14 grid gap-10 md:grid-cols-4">
        ...
        <div>
          ...
          <ul className="space-y-2.5 text-sm">
            <li><Link to="/details" hash="service-residential-construction" className="hover:text-primary transition">Residential Construction</Link></li>
            <li><Link to="/details" hash="service-renovation-remodeling" className="hover:text-primary transition">Renovation & Remodeling</Link></li>
            <li><Link to="/details" hash="service-civil-works" className="hover:text-primary transition">Civil Works</Link></li>
            <li><Link to="/details" hash="service-design-build-services" className="hover:text-primary transition">Design-Build Services</Link></li>
            <li><Link to="/details" hash="service-3d-rendering-visualization" className="hover:text-primary transition">3D Rendering</Link></li>
          </ul>
        </div>
